...
export const CertificateText = ({ text, wpcontent }: { text: any; wpcontent: any }) => {
  return (
    <Container maxW="7xl" py={{ base: 8, md: 16 }}>
      <Heading as="h1" size={{ base: "lg", md: "xl" }} mb={8} display="flex" alignItems={{ base: "start", md: "center" }}>
      ...
      <Box
        ...
        sx={{
          ...
          "ul": { pl: 6, mb: 4 },
          "li": { mb: 2 },
          "img": { maxW: "100%", height: "auto", display: "block !important", mx: "auto !important" },
          "figure": { maxW: "100%", height: "auto", m: "0 auto !important", textAlign: "center" },
